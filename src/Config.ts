...
export const curatedArticles = [
  {
    ...
    text: "Making Ethereum easier to use is the main key for mass adoption of cryptocurrencies and blockchain technology.",
    tags: ["Blockchain"],
  },
  {
  ...
  },
  {
    ...
    text: "Blockstack makes it easy for people to access and utilize the powerful privacy that blockchain technology has to offer utilizing a (PoX) system backed by Bitcoin.",
    tags: ["Blockchain"],
  },
  {
    title: "Tech Uses",
    ...
    text: "As a Software Engineer i'm constantly tweaking and playing around with the technologies I use. Here's the current things I use almost daily 😘",
    tags: ["Tech", "Personal"],
  },
  {
    ...
    text: 'So I was lying in bed browsing Instagram when my girlfriend snapchats me. "Funny" I thought, since she was passed out next to me',
    tags: ["Security"],
  },
  {
